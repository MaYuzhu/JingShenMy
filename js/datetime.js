...
function(){
	...
	fd.write('<table width="100%" border="0" bgcolor="#CCCCCC" cellspacing="1" cellpadding="0">'+
			 '<tr><td><table border="0" cellspacing="0" bgcolor="#b9b8b8" cellpadding="0" width="100%">'+
			 ...
			 '<tr bgcolor="#FFFFFF"><td><table width="100%" border="0" bgcolor="#CCC" cellspacing="1" cellpadding="0">'+
			 '<tr bgcolor="#CCC" height="18"><td>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></tr></table></td></tr>'+
